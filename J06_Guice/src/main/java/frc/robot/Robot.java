...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    initConfig(configFile.toString(),
        "/home/lvuser/config.properties",
        "/u/config.properties");
    robotContainer = RobotConfig.getInstance(RobotContainer.class);
    Constants.init();
  }

  public void initConfig(String... fileNames) {
    Config.cleanAllPreferences();
    Config.loadConfiguration(fileNames);
